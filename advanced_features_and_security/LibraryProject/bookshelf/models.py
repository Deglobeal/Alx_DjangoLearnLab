...
# 📌 Fixed: Book Model with Proper Permissions
from django.db import models
...
# 📌 Fixed: Library Model with Correct Many-to-Many Relationship
class Library(models.Model):
    name = models.CharField(max_length=255)
    location = models.CharField(max_length=255)
    books = models.ManyToManyField(Book, through='LibraryBook')  # Fixed reference

    def __str__(self):
        return self.name

# 📌 Fixed: LibraryBook Correctly Links Library and Book
